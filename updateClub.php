                ...
                while ($collect_row = $collect_result->fetch_array()) {
                    ...
                    <main>
                        ...
                        <form action="updateClub.php" method="post">
                            Club Name:<br>
                            <input type="text" name="clubNameUpdate" value="<?php echo htmlspecialchars($_clubName); ?>">
                            <br>
                            <br>
                            Club Genre:<br>
                            <input type="text" name="clubGenreUpdate" value="<?php echo htmlspecialchars($_clubGenre); ?>">
                            <br>
                            <br>
                            Club Email:<br>
                            <input type="text" name="clubEmailUpdate" value="<?php echo htmlspecialchars($_clubEmail); ?>">
                            <br>
                            <br>
                            Club Website:<br>
                            <input type="text" name="clubWebsiteUpdate" value="<?php echo htmlspecialchars($_clubWebsite); ?>">
                            <br>
                            <br>
                            Contact Name:<br>
                            <input type="text" name="contactNameUpdate" value="<?php echo htmlspecialchars($_contactName); ?>">
                            <br>
                            <br>
                            Contact Num:<br>
                            <input type="text" name="contactNumberUpdate" value="<?php echo htmlspecialchars($_contactNo); ?>">
                            <br>
                            <br>
                            Description:<br>
